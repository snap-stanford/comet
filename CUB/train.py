...
if __name__=='__main__':
    ...
    if params.method in ['baseline', 'baseline++'] :
        ...
        base_loader     = base_datamgr.get_data_loader( base_file , aug = params.train_aug, is_train=True)
        val_datamgr     = SimpleDataManager(image_size, batch_size = 64)
        val_loader      = val_datamgr.get_data_loader( val_file, aug = False, is_train=False)
    ...
    wandb.init(project="fewshot_images", tensorboard=True, name=store_name)
