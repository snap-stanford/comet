...
def parse_args(script):
    ...
    parser.add_argument('--dataset'     , default='Gene',        help='CUB/miniImagenet/cross/omniglot/cross_char')
    ...
    parser.add_argument('--exp_str', default='0', type=str, help='just to add some clarification for each exp')
